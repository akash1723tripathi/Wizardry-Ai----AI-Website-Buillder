...
function getColorDepth() {
  ...
  if (getEnvVar("NODE_DISABLE_COLORS") !== void 0 && getEnvVar("NODE_DISABLE_COLORS") !== "" || getEnvVar("NO_COLOR") !== void 0 && getEnvVar("NO_COLOR") !== "" || getEnvVar("TERM") === "dumb")
    return COLORS_2;
  if (getEnvVar("TMUX"))
    return COLORS_16m;
...
var WindowBroadcastChannel = class {
  ...
  setup() {
    ...
    const handler = (event) => {
      ...
      if ((message == null ? void 0 : message.event) !== "session" || !(message == null ? void 0 : message.data))
        return;
  ...
  const setupPolling = () => {
    if (refetchInterval && refetchInterval > 0)
      state.pollInterval = setInterval(() => {
        var _a2;
        if ((_a2 = sessionAtom.get()) == null ? void 0 : _a2.data)
...
var getClientConfig = (options, loadEnv) => {
  ...
  for (const plugin of plugins)
    if (plugin.getActions)
      pluginsActions = defu(((_g = plugin.getActions) == null ? void 0 : _g.call(plugin, $fetch, $store, options)) ?? {}, pluginsActions);
  return {
    get baseURL() {
      return baseURL;
    },
